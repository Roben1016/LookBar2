...
//        private BlinkLayout mBlinkLayout;
        ...
        private void setDefaultEmpty() {
            mPageLayout.mEmpty = mInflater.inflate(R.layout.page_layout_empty, mPageLayout, false);
        ...
        private void setDefaultError() {
            mPageLayout.mError = mInflater.inflate(R.layout.page_layout_error, mPageLayout, false);
        ...
        private void setDefaultLoading() {
            mPageLayout.mLoading = mInflater.inflate(R.layout.page_layout_loading2, mPageLayout, false);
...
//            mPageLayout.mBlinkLayout = mBlinkLayout;
            ...
            mProgressBar = mPageLayout.mLoading.findViewById(R.id.progressbar_loading);
        ...
        public Builder setLoadingProgressBarTink(ColorStateList drawable) {
            if (mProgressBar != null && drawable != null) {
                mProgressBar.setIndeterminateTintList(drawable);
            }
            return this;
        }
