...
public class SPUtil {
	...
	public static void setParam(String key, Object object){
		...
		SharedPreferences sp = BaseApplication.getIns().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
	...
	public static Object getParam(String key, Object defaultObject) {
		...
		SharedPreferences sp = BaseApplication.getIns().
	...
	public static void setObjectBean(String key, Object saveObject) {
		SharedPreferences sharedPreferences = BaseApplication.getIns().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
