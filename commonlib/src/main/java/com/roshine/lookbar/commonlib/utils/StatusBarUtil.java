...
//        }
    ...
    public static void setDarkMode(Activity activity) {
        setMIUILightStatusBar(activity, false);
    ...
    private static boolean setMIUILightStatusBar(Activity activity,boolean darkIcon) {
    ...
    private static boolean setFlymeLightStatusBar(Activity activity,boolean darkIcon) {
