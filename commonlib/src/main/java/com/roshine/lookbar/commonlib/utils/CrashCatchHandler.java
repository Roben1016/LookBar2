...
//    }.start();
    //保存日志文件
    if(Utils.isAppDebug()){//debug 模式下保存崩溃日志
...
//      LogUtil.show("an error occured when collect package info");
//    }
//    //获取所有系统信息
...
//      } catch (Exception e) {
//        LogUtil.show("an error occured when collect crash info");
//      }
//    }
  }
...
//    }
    ...
    try {
      ...
      if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
        String path = Environment.getExternalStorageDirectory() + "/student_ruizhi/crashlog/";//设置崩溃日志保存目录
