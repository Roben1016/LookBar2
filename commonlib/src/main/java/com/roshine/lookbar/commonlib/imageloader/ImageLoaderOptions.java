package com.roshine.lookbar.commonlib.imageloader;
...
//    public ImageLoaderListener getListener(){return listener;}
    ...
    public final static  class Builder{
        ...
        private String url;  // 图片地址
        private int holderDrawable= com.roshine.lookbar.commonres.R.drawable.image_loader_empty;  // 设置展位图
