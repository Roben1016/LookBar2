...
public class ToastUtil {
    ...
    public static void showShort(String message) {
        if (null == toast) {
            toast = Toast.makeText(BaseApplication.getIns(), message, Toast.LENGTH_SHORT);
        } else {
    ...
    public static void showLong(String message) {
        if (null == toast) {
            toast = Toast.makeText(BaseApplication.getIns(), message, Toast.LENGTH_LONG);
        } else {
            toast.setText(message);
    ...
    public static void showWithTime(String message, int duration) {
        if (null == toast) {
            toast = Toast.makeText(BaseApplication.getIns(), message, duration);
