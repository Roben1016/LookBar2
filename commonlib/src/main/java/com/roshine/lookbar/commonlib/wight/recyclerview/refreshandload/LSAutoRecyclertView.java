...
import com.roshine.lookbar.commonlib.wight.recyclerview.headandfoot.HeadAndFootAdapter;
...
import com.roshine.lookbar.commonlib.wight.recyclerview.interfaces.OnItemLongClickListener;
...
//        clearItemAnimator();
    ...
    private void initLoadMoreView() {
        if (mLoadMoreView == null) {
            mLoadMoreView = LayoutInflater.from(getContext()).inflate(com.roshine.lookbar.commonlib.R.layout
                    .common_glorious_recyclerview_layout_load_more, this,false);
        }
//        mLoadMoreView.setBackgroundColor(mLoadMoreBackgroundColor);
        mTvLoadMore = (TextView) mLoadMoreView.findViewById(com.roshine.lookbar.commonlib.R.id.tv_loading_more);
        mPbLoadMore = (ProgressBar) mLoadMoreView.findViewById(com.roshine.lookbar.commonlib.R.id.pb_loading_more);
        if (pbDrawable != null) {
        ...
        mLoadMoreView.setOnClickListener(v -> {
            if(loadFailed && mLoadMoreListener != null){
                loadFailed = false;
                hasLoadingMore = true;
                mTvLoadMore.setText(getContext().getString(com.roshine.lookbar.commonlib.R.string.common_glorious_recyclerview_loading_more));
...
//            }
                ...
                if (layoutManager.getChildCount() > 0
                    ...
                    if (mLoadMoreListener != null) {
                        ...
                        if (mPbLoadMore != null && mTvLoadMore != null) {
                            mPbLoadMore.setVisibility(View.VISIBLE);
                            mTvLoadMore.setText(getContext().getResources().getString(com.roshine.lookbar.commonlib.R.string.common_glorious_recyclerview_loading_more));
                        }
    ...
    public void setLoadMoreFinish(int status) {
        ...
        switch (status) {
            ...
            case LOAD_MORE_FAIL:
                loadFailed = true;
                mTvLoadMore.setText(getContext().getString(com.roshine.lookbar.commonlib.R.string.common_load_failed_bottom));
...
//                mAdapter.removeFootView(mLoadMoreView);
            ...
            case LOAD_NO_MORE:
                hasMore = false;
                mAdapter.removeFootView(mLoadMoreView);
                mTvLoadMore.setText(getContext().getString(com.roshine.lookbar.commonlib.R.string.common_no_more_text));
                mPbLoadMore.setVisibility(View.GONE);
                mAdapter.addFootView(mLoadMoreView);
                break;
            default:
